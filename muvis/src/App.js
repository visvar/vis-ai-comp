              ...
              <Grid container direction='column' item spacing={2} align='left'>
                ...
                >
                  ...
                  <span style={{ whiteSpace: 'pre-line' }}>
                    ...
                    'Undo: crtl + z \n' + 
                    'create new note: brush + N' + 
                    'copy and paste notes: drag + c then release and v' + 
                    'delete note: drag + delete or alt and click on note'}
                  </span>
                </Grid>
                <Grid
                  item
                ...
                >
                  ...
                  <span style={{ whiteSpace: 'pre-line' }}>
                    {'Select a specific Midi Input or use all at the same time (default). \n' +
                    'A simple input via pc-keyboard is also possible using buttons from a to l ' +
                    'corresponding to C4 to D5, while # notes are placed like on a real keyboard (w, e, t ...). ' +
                ...
                >
                  ...
                  <span style={{ whiteSpace: 'pre-line' }}>
                    ...
                    'empty, the seed is selected by brushing or automatically the whole the composition' +
                    'or children. \n' +
                    ...
                    'All samples are evenly distributed along the temperature range, therefore 2 melodies never use' +
                ...
                >
                  ...
                  <span style={{ whiteSpace: 'pre-line' }}>
                    ...
                    'Pressing ctrl while drag changes the duration of the note. (Also works by dragging at the right edge of a note)\n' +
                    ...
                    'Single samples can be selected in the toolbar and added to the composition' +
                    'using the plus on the right.\n' +
                    'Notes can be copied by pressing c while draging and be pasted via v.' +
                    'To delete notes press alt and click on a note or hold a note and press delete.' +
                    'Or brush multiple notes and delete them with delete.'}
                  </span>
                </Grid>
                <Grid
                  item
                ...
                >
                  ...
                  <span style={{ whiteSpace: 'pre-line' }}>
                    ...
                    'Hover over a piano roll (pitch) line to highlight the specific pitch in every piano roll.' +
                ...
                >
                  ...
                  <span style={{ whiteSpace: 'pre-line' }}>
                    ...
                    'Right clicking on the background of a note displays the path in the piano roll below.'}
                  </span>
                </Grid>
                <Grid
                  item
                ...
                >
                  ...
                  <span style={{ whiteSpace: 'pre-line' }}>
                    {'If the view is empty, click the eye icon on the left next to the title.\n'+
                    ...
                    'and the weighting between rhythm and melody for our distance function (icon with 3 dots).\n'+
                    'We allow to change visual representation like glyphs and scales or sorting (eye icon on the right).\n'+
                    'Zoom and pan by pressing ctrl; reset zoom and pan by alt + left click.'+
                    'Right click near a point to listen to the sample.'}
                  </span>
                </Grid>
                <Grid
                  item
